...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/css/loginpage.css">
    <!-- endinject -->
...
<script src="${pageContext.request.contextPath}/static/assets/js/login.js"></script>
